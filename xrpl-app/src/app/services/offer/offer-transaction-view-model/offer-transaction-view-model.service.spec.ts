...
describe('OfferTransactionViewModelService', () => {
     ...
     beforeEach(() => {
          ...
          TestBed.configureTestingModule({
               providers: [OfferTransactionViewModelService, { provide: WalletManagerService, useValue: walletManagerService }, { provide: TransactionUiService, useValue: new MockTransactionUiService() }, { provide: OfferStoreService, useValue: offerStoreService }, { provide: OfferCurrencyService, useValue: offerCurrency }],
          });
     ...
     describe('weSpendIssuerItems', () => {
          it('should return formatted spend issuer items', () => {
               const mockIssuers: IssuerItem[] = [{ address: 'rSpendIssuer1234567890', name: 'Spend Issuer' }];
     ...
     describe('selectedWeSpendIssuerItem', () => {
          it('should return the selected spend issuer item', () => {
               const mockIssuers: IssuerItem[] = [{ address: 'rSpendIssuer123', name: 'Spend Issuer' }];
