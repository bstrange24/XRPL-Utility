...
describe('OfferCurrencyService', () => {
     ...
     beforeEach(() => {
          ...
          TestBed.configureTestingModule({
               providers: [OfferCurrencyService, { provide: StorageService, useValue: storageService }, { provide: XrplService, useValue: xrplService }, { provide: UtilsService, useValue: utilsService }, { provide: WalletManagerService, useValue: walletManagerService }],
          });
     });
