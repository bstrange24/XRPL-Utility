...
describe('OfferTransactionOrchestratorService', () => {
     ...
     describe('executeOfferTx', () => {
          ...
          describe('createOffer', () => {
               ...
               it('should handle simulation mode', async () => {
                    ...
                    expect(toastService.success).toHaveBeenCalledWith('Simulated Offer Create successfully!', AppConstants.TOAST.SUCCESS, false, 'txHash123', 'https://explorer.xrpl.org/tx/');
                    expect(result.success).toBe(true);
                    expect(result.hash).toBe('txHash123');
          ...
          describe('cancelOffer', () => {
               ...
               it('should stop on first failure in sequence', async () => {
                    ...
                    xrplTransactionOrchestratorService.executeTx.and.returnValues(Promise.resolve({ success: true, hash: 'txHash1' }), Promise.resolve({ success: false, error: 'Second offer failed' }));
               ...
               it('should add all tx hashes to UI service', async () => {
                    ...
                    xrplTransactionOrchestratorService.executeTx.and.returnValues(Promise.resolve({ success: true, hash: 'txHash1' }), Promise.resolve({ success: true, hash: 'txHash2' }), Promise.resolve({ success: true, hash: 'txHash3' }));
     ...
     describe('Edge cases', () => {
          ...
          it('should handle create offer with multi-sign', async () => {
               ...
               expect(xrplTransactionOrchestratorService.executeTx).toHaveBeenCalledWith(
