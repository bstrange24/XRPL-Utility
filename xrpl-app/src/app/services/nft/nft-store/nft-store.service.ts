...
const initialState: NFtState = {
     ...
     isNftOwner: false,
     isCollapsed: false,
     nftOwnerAddress: null as unknown as string,
     nfTokenMinterAddress: null as unknown as string,
