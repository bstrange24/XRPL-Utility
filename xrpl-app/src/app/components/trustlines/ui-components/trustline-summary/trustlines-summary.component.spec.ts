...
import { TrustlinesSummaryComponent } from './trustlines-summary.component';
...
describe('TrustlinesSummaryComponent', () => {
     let component: TrustlinesSummaryComponent;
     let fixture: ComponentFixture<TrustlinesSummaryComponent>;
     ...
     beforeEach(async () => {
          ...
          await TestBed.configureTestingModule({
               imports: [TrustlinesSummaryComponent],
               ...
               .overrideComponent(TrustlinesSummaryComponent, {
                    set: {
          ...
          fixture = TestBed.createComponent(TrustlinesSummaryComponent);
