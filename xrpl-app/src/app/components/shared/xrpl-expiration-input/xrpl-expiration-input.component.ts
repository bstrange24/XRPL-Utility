...
export class XrplExpirationInputComponent implements AfterViewInit, OnDestroy {
     ...
     @Input() errorMessage = '';
     @Input() expirationType: 'nftOffer' | 'finish' | 'cancel' | 'paymentChannel' | 'check' | 'credential' = 'cancel'; // NEW INPUT
          ...
          effect(() => {
               ...
               switch (this.expirationType) {
                    ...
                    case 'check':
                         ...
                         break;
                    case 'nftOffer':
                         secondsRemaining = this.realTimeService.nftOfferSecondsRemaining();
                         timeRemainingText = this.realTimeService.nftOfferTimeRemaining();
                         break;
                    default:
                         secondsRemaining = this.realTimeService.escrowCancelAfterSecondsRemaining();
                         timeRemainingText = this.realTimeService.escrowCancelAfterTimeRemaining();
