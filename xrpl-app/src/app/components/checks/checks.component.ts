...
@Component({
     selector: 'app-checks',
     standalone: true,
     imports: [CommonModule, FormsModule, NgIcon, LucideAngularModule, OverlayModule, NavbarComponent, WalletPanelComponent, TransactionPreviewComponent, SelectSearchDropdownComponent, TransactionOptionsSectionComponent, CheckCreateItemComponent, CheckCancelItemComponent, CheckCashItemComponent],
     animations: [
