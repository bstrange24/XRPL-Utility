...
import { TransactionUiService } from '../../services/transaction-ui.service';
import { TransactionFormShellComponent } from '../transaction-form-shell/transaction-form-shell.component';
...
@Component({
     ...
     standalone: true,
     imports: [CommonModule, FormsModule, AppWalletDynamicInputComponent, NavbarComponent, LucideAngularModule, NgIcon, TransactionFormShellComponent],
...
export class DeleteAccountComponent implements OnInit, AfterViewInit {
     ...
     constructor(private readonly xrplService: XrplService, private readonly utilsService: UtilsService, private readonly cdr: ChangeDetectorRef, private readonly storageService: StorageService, private readonly xrplTransactions: XrplTransactionService, private ngZone: NgZone, private walletGenerator: WalletGeneratorService, private walletManagerService: WalletManagerService, protected ui: TransactionUiService) {}
     ...
     async toggleMultiSign() {
          try {
               ...
               this.setError(`ERROR getting wallet in toggleMultiSign' ${error.message}`);
          }
     }
     ...
     async deleteAccount() {
          ...
          try {
               ...
               this.showSpinnerWithDelay(this.isSimulateEnabled ? 'Simulating Deleting Account (no changes will be made)...' : 'Submitting Delete Account to Ledger...', 200);

               // this.ui.paymentTx.push(accountDeleteTx);
               this.paymentTx.push(accountDeleteTx);
               ...
               if (!this.isSimulateEnabled) {
                    this.successMessage = 'Wallet deleted successfully!';
                    ...
                    this.successMessage = 'Simulated Wallet delete successfully!';
               }
          } catch (error: any) {
     ...
     private async setTxOptionalFields(client: xrpl.Client, deleteTx: any, wallet: xrpl.Wallet, accountInfo: any) {
          if (this.selectedSingleTicket) {
               ...
               if (!ticketExists) {
                    ...
                    this.setError(`ERROR: Ticket Sequence ${this.selectedSingleTicket} not found for account ${wallet.classicAddress}`);
               }
