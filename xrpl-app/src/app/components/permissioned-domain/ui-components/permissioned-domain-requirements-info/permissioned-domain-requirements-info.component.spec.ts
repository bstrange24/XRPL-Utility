...
import { PermissionedDomainRequirementsInfoComponent } from './permissioned-domain-requirements-info.component';

describe('PermissionedDomainRequirementsInfoComponent', () => {
     let component: PermissionedDomainRequirementsInfoComponent;
     let fixture: ComponentFixture<PermissionedDomainRequirementsInfoComponent>;
     ...
     beforeEach(async () => {
          ...
          await TestBed.configureTestingModule({
               imports: [PermissionedDomainRequirementsInfoComponent, NoopAnimationsModule],
               providers: [
          ...
          fixture = TestBed.createComponent(PermissionedDomainRequirementsInfoComponent);
