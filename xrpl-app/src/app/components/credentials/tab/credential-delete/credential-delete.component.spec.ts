...
describe('CredentialDeleteComponent', () => {
     ...
     beforeEach(async () => {
          credentialStore = {
               ...
               deleteCredential: jasmine.createSpy('deleteCredential'),
          };

          credentialUtilService = {
               validateCredential: jasmine.createSpy('validateCredential'),
               onCredentialSelected: jasmine.createSpy('onCredentialSelected'),
          };

          credentialViewModel = {
               activeTab: signal('deleteCredential'),
               infoData: signal({ walletName: 'Test', credentialCount: 3 }),
          };
          ...
          await TestBed.configureTestingModule({
               ...
               .overrideComponent(CredentialDeleteComponent, { set: { template: '<div></div>' } })
               .compileComponents();
     ...
     describe('Template bindings (indirect tests)', () => {
          ...
          it('should have creds available for template', () => {
               ...
               expect(component.creds().dropdown.length).toBe(3);
          });
