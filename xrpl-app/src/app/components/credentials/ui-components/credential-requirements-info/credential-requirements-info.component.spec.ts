...
import { CredentialRequirementsInfoComponent } from './credential-requirements-info.component';

describe('CredentialRequirementsInfoComponent', () => {
     let component: CredentialRequirementsInfoComponent;
     let fixture: ComponentFixture<CredentialRequirementsInfoComponent>;
     ...
     beforeEach(async () => {
          ...
          fixture = TestBed.createComponent(CredentialRequirementsInfoComponent);
