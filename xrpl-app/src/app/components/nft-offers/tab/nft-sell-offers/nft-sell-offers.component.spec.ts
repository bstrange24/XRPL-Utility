...
describe('NftSellOffersComponent', () => {
     ...
     beforeEach(async () => {
          ...
          await TestBed.configureTestingModule({
               ...
               .overrideComponent(NftSellOffersComponent, { set: { template: '<div></div>' } })
               .compileComponents();
     ...
     describe('Edge cases', () => {
          ...
          it('should handle empty existingNfts', () => {
               nftCreateStoreService.existingNfts.set([]);
               const nfts = component.nftCreateStoreService.existingNfts();
               expect(nfts).toEqual([]);
          });
