...
describe('EscrowCreateItemComponent', () => {
     ...
     describe('Edge cases', () => {
          ...
          it('should handle escrow with missing destination', () => {
               const escrowWithoutDestination = {
                    ...mockEscrow,
                    destination: '',
               };
               component.escrow = escrowWithoutDestination;
               fixture.detectChanges();

               expect(component.escrow.destination).toBe('');
          });
