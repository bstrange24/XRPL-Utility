...
export const AppConstants = {
     ...
     PAYMENT_CHANNEL_AMOUNT_HELPER_ITEMS: ['This is the maximum amount of XRP that can be claimed through this channel', 'You can claim less than this amount over time', 'The full amount is reserved from your account until the channel is closed', 'XRP precision up to 0.000001'],
